...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Penjualan Barang");
        ...
        btnproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (total >=200000) {
                    ...
                    txtbonus.setText("Bonus : CPU");
                }
                else  {
                    txtbonus.setText("Tidak Ada Bonus");
                }
                ...
                if (ub<total){
                    ...
                    txtketerangan.setText("Keterangan : Tunggu Uang Kembalian");
